...
" General {{{
	...
	"set foldmethod=indent  " fold using syntax by default
...
" Command (re)mapings {{{
	...
	"autocmd FileType python nnoremap <leader>l <esc>:retab<cr><esc>:PymodeLintAuto<cr><esc>:PymodeLint<cr> 
	autocmd FileType python nnoremap <leader>l <esc>:retab<cr><esc>:Neomake<cr> 
	"<esc>:retab<cr><esc>:Isort<cr><esc>:PymodeLintAuto<cr><esc>:PymodeLint<cr>
...
" FileType tabs, folding, wrapping, spelling {{{
	...
	autocmd FileType c,cpp,h,hpp,cuda,cu,cuh setlocal smartindent cindent shiftwidth=2 tabstop=2 softtabstop=2 expandtab
	...
	" OCaml -- whitespace sensitive
	autocmd FileType ocaml setlocal expandtab shiftwidth=2 tabstop=2 softtabstop=2
...
"
	...
	" NERDTree -- file browser on left (mnemonic: All files) {{{
		...
		noremap <silent> <leader>ao <esc>:NERDTree<cr><c-w>=
		noremap <silent> <leader>ac <esc>:NERDTreeClose<cr><c-w>=
		noremap <silent> <leader>at <esc>:NERDTreeToggle<cr><c-w>=
